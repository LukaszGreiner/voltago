...
<template>
  <main class="flex place-items-center lg:flex-row-reverse h-screen">
    ...
    >
      ...
      >
        <source
          ...
          srcset="../assets/img/Voltago-hero__desktop.png"
        />
        <source
          media="(min-width: 720px)"
          srcset="../assets/img/Voltago-hero__tablet.jpg"
        />
        <img src="../assets/img/Voltago-hero__mobile.jpg" alt="Hero Image" />
      </picture>
    </div>
    <!-- Call to action -->
    <div class="flex flex-col flex-end z-20 lg:block max-w-[528px] right-0">
      ...
      <h2 class="text-2xl font-regular mb-3">
